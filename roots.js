const rootsButtonHTML = document.getElementById('roots');
...
function squareRoots(a,b,c) {
    ...
    if (a === 0)
        return [-c / b]; // нахождение корня для линейного уравнения
...
rootsButtonHTML.addEventListener('click', squareRootsTests);
